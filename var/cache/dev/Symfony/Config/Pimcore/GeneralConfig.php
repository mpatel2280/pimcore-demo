...
class GeneralConfig 
{
     ...
     * @default 'en'
     * @param ParamConfigurator|mixed $value
     * @deprecated The child node "language" at path "general" is deprecated.
     * @return $this
     */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('required_languages', $value)) {
            $this->_usedProperties['requiredLanguages'] = true;
            $this->requiredLanguages = $value['required_languages'];
            unset($value['required_languages']);
        }
