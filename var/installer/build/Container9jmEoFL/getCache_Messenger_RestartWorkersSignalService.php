...
class getCache_Messenger_RestartWorkersSignalService extends Pimcore_Bundle_InstallBundle_InstallerKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['cache.messenger.restart_workers_signal'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('O2zfPMDm3t', 0, (\dirname(__DIR__, 2).'/cache/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
